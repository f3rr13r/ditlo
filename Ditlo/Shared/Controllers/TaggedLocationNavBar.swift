...
class TaggedLocationNavBar: BaseView {
    ...
    let taggedLocationLabel: MarqueeLabel = {
    ...
    func anchorSubviews() {
        ...
        topContentRowView.addSubview(taggedLocationLabel)
        taggedLocationLabel.anchor(withTopAnchor: logoImageView.bottomAnchor, leadingAnchor: logoImageView.leadingAnchor, bottomAnchor: nil, trailingAnchor: calendarButton.leadingAnchor, centreXAnchor: nil, centreYAnchor: nil, widthAnchor: nil, heightAnchor: nil, padding: .init(top: 10.0, left: 0.0, bottom: 0.0, right: -12.0))
        
        topContentRowView.addSubview(locationNameLabel)
        locationNameLabel.anchor(withTopAnchor: taggedLocationLabel.bottomAnchor, leadingAnchor: taggedLocationLabel.leadingAnchor, bottomAnchor: topContentRowView.bottomAnchor, trailingAnchor: topContentRowView.trailingAnchor, centreXAnchor: nil, centreYAnchor: nil, widthAnchor: nil, heightAnchor: nil, padding: .init(top: 0.0, left: 0.0, bottom: 0.0, right: -horizontalPadding))
    }
