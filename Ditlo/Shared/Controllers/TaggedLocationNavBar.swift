...
protocol TaggedLocationNavBarDelegate {
    func backButtonPressed()
}

class TaggedLocationNavBar: BaseView {
    ...
    let taggedLocationTitleLabel: MarqueeLabel = {
    ...
    var locationNameContainerMaxWidthConstraint: NSLayoutConstraint!
    
    let locationNameLabel: MarqueeLabel = {
        let label = MarqueeLabel()
        label.text = "U.S Bank Stadium, Minneapolis, USA"
    ...
    // delegate
    var delegate: TaggedLocationNavBarDelegate?
    ...
    func anchorSubviews() {
        ...
        topContentRowView.addSubview(taggedLocationTitleLabel)
        taggedLocationTitleLabel.anchor(withTopAnchor: logoImageView.bottomAnchor, leadingAnchor: backButton.trailingAnchor, bottomAnchor: nil, trailingAnchor: calendarButton.leadingAnchor, centreXAnchor: nil, centreYAnchor: nil, widthAnchor: nil, heightAnchor: nil, padding: .init(top: 0.0, left: 0.0, bottom: 0.0, right: -12.0))
        
        addSubview(locationNameContainer)
        locationNameContainer.anchor(withTopAnchor: topContentRowView.bottomAnchor, leadingAnchor: taggedLocationTitleLabel.leadingAnchor, bottomAnchor: bottomAnchor, trailingAnchor: nil, centreXAnchor: nil, centreYAnchor: nil, widthAnchor: nil, heightAnchor: 36.0, padding: .init(top: 2.0, left: 0.0, bottom: 0.0, right: 0.0))
        locationNameContainerMaxWidthConstraint = NSLayoutConstraint(item: locationNameContainer, attribute: .trailing, relatedBy: .lessThanOrEqual, toItem: self, attribute: .trailing, multiplier: 1.0, constant: -horizontalPadding)
        addConstraint(locationNameContainerMaxWidthConstraint)
        locationNameContainer.addSubview(locationNameLabel)
        locationNameLabel.anchor(withTopAnchor: nil, leadingAnchor: locationNameContainer.leadingAnchor, bottomAnchor: nil, trailingAnchor: locationNameContainer.trailingAnchor, centreXAnchor: nil, centreYAnchor: locationNameContainer.centerYAnchor, widthAnchor: nil, heightAnchor: nil, padding: .init(top: 0.0, left: 16.0, bottom: 0.0, right: -16.0))
    }
