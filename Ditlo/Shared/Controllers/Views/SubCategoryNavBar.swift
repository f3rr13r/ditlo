...
protocol SubCategoryNavBarDelegate {
    func backButtonPressed()
    func calendarButtonPressed()
    func navigationCellSelected(itemIndex: IndexPath)
}

class SubCategoryNavBar: BaseView {
    
    // injector variables
    var categoryName: String = "" {
        didSet {
            categoriesTitleLabel.text = categoryName
        }
    }
    
    var sections: [NavigationCellContent] = [] {
        didSet {
            categoriesTitleLabel.textColor = sections[0].colour
    ...
    // delegate
    var delegate: SubCategoryNavBarDelegate?
    ...
    func anchorSubviews() {
        ...
        categoriesTitleLabel.anchor(withTopAnchor: logoImageView.bottomAnchor, leadingAnchor: backButton.trailingAnchor, bottomAnchor: nil, trailingAnchor: calendarButton.leadingAnchor, centreXAnchor: nil, centreYAnchor: nil, widthAnchor: nil, heightAnchor: nil, padding: .init(top: 0.0, left: 0.0, bottom: 0.0, right: -12.0))
...
extension SubCategoryNavBar: NavigationCollectionViewDelegate {
    func navigationCellSelected(itemIndex: IndexPath) {
