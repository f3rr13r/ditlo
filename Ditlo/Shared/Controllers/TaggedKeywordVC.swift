...
class TaggedKeywordVC: UIViewController {

    // views
    let taggedKeywordNavBar = TaggedKeywordNavBar()
    ...
    func setupCustomNavigationBarContent() {
        if let navigationController = self.navigationController {
            ...
            navigationController.navigationBar.addSubview(taggedKeywordNavBar)
            taggedKeywordNavBar.anchor(withTopAnchor: navigationController.navigationBar.topAnchor, leadingAnchor: navigationController.navigationBar.leadingAnchor, bottomAnchor: nil, trailingAnchor: navigationController.navigationBar.trailingAnchor, centreXAnchor: nil, centreYAnchor: nil)
            taggedKeywordNavBar.delegate = self
            navigationController.navigationBar.layoutIfNeeded()
        }
    }
    
    func destroyCustomNavigationBarContent() {
        taggedKeywordNavBar.removeFromSuperview()
    }
...
extension TaggedKeywordVC: UICollectionViewDataSource {
...
extension TaggedKeywordVC: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
extension TaggedKeywordVC: TaggedKeywordNavBarDelegate {
...
extension TaggedKeywordVC: SectionCellDelegate {
...
extension TaggedKeywordVC: DitloPlayerPopupActionDelegate {
