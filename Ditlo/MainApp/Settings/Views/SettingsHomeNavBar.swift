...
protocol SettingsHomeNavBarDelegate {
    func backButtonPressed()
    func logoutButtonPressed()
}

class SettingsHomeNavBar: BaseView {
    ...
    let logoutIcon: UIImageView = {
        let iv = UIImageView()
        iv.contentMode = .scaleAspectFit
        iv.image = #imageLiteral(resourceName: "logout-icon")
        return iv
    }()
    ...
    // delegate
    var delegate: SettingsHomeNavBarDelegate?
    ...
    func anchorSubviews() {
        ...
        topRowView.addSubview(logoutButton)
        logoutButton.anchor(withTopAnchor: topRowView.topAnchor, leadingAnchor: nil, bottomAnchor: topRowView.bottomAnchor, trailingAnchor: topRowView.trailingAnchor, centreXAnchor: nil, centreYAnchor: nil, widthAnchor: 58.0, heightAnchor: nil)
        logoutButton.addSubview(logoutIcon)
        logoutIcon.anchor(withTopAnchor: nil, leadingAnchor: nil, bottomAnchor: nil, trailingAnchor: logoutButton.trailingAnchor, centreXAnchor: nil, centreYAnchor: logoutButton.centerYAnchor, widthAnchor: 24.0, heightAnchor: 24.0, padding: .init(top: 0.0, left: 0.0, bottom: 0.0, right: -horizontalPadding))
        
        topRowView.addSubview(centreInfoContainerView)
        centreInfoContainerView.anchor(withTopAnchor: nil, leadingAnchor: roundedBorderView.trailingAnchor, bottomAnchor: nil, trailingAnchor: logoutButton.leadingAnchor, centreXAnchor: nil, centreYAnchor: topRowView.centerYAnchor, widthAnchor: nil, heightAnchor: nil, padding: .init(top: 0.0, left: 12.0, bottom: 0.0, right: -12.0))
        ...
        settingsTitleLabel.anchor(withTopAnchor: topRowView.bottomAnchor, leadingAnchor: leadingAnchor, bottomAnchor: bottomAnchor, trailingAnchor: trailingAnchor, centreXAnchor: nil, centreYAnchor: nil, widthAnchor: nil, heightAnchor: nil, padding: .init(top: 12.0, left: horizontalPadding, bottom: 0.0, right: -horizontalPadding))
    }
